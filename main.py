...
cards = [Card(0, "Поле вперед"),
         CityCard(1, 1, "Гдыня", 600, 20, 100, 300, 900, 1600, 2500, 500, 500),
         Card(2, "Шанс"),
         CityCard(3, 1, "Тайбэй", 600, 40, 200, 600, 1800, 3200, 4500, 500, 500),
         TaxCard("Подоходный налог", 4, 2000),
         TransportCard(5, "Железная дорога"),
         CityCard(6, 2, "Токио", 1000, 60, 300, 900, 2700, 4000, 5500, 500, 500),
         Card(7, "Шанс"),
         CityCard(8, 2, "Барселона", 1000, 60, 300, 900, 2700, 4000, 5500, 500, 500),
         CityCard(9, 2, "Афины", 1200, 80, 400, 1000, 3000, 4500, 6000, 500, 500),
         Card(10, "Тюрьма"),
         CityCard(11, 3, "Стамбул", 1400, 100, 500, 1500, 4500, 6250, 7500, 1000, 1000),
         EnergyCard(12, "Солнечная энергия"),
         CityCard(13, 3, "Киев", 1400, 100, 500, 1500, 4500, 6250, 7500, 1000, 1000),
         CityCard(14, 3, "Торонто", 1600, 120, 600, 1800, 5000, 7000, 9000, 1000, 1000),
         TransportCard(15, "Авиакомапния"),
         CityCard(16, 4, "Рим", 1800, 140, 700, 2000, 5500, 7500, 9500, 1000, 1000),
         Card(17, "Шанс"),
         CityCard(18, 4, "Шанхай", 1800, 140, 700, 2000, 5500, 7500, 9500, 1000, 1000),
         CityCard(19, 4, "Ванкувер", 2000, 160, 800, 2200, 6000, 8000, 10000, 1000, 1000),
         Card(20, "Парковка"),
         CityCard(21, 5, "Сидней", 2200, 180, 900, 2500, 7000, 8750, 10500, 1500, 1500),
         Card(22, "Шанс"),
         CityCard(23, 5, "Нью Йорк", 2200, 180, 900, 2500, 7000, 8750, 10500, 1500, 1500),
         CityCard(24, 5, "Лондон", 2400, 200, 1000, 3000, 7500, 9250, 11000, 1500, 1500),
         TransportCard(25, "Круиз"),
         CityCard(26, 6, "Пекин", 2600, 220, 1100, 3300, 8000, 9750, 11500, 1500, 1500),
         CityCard(27, 6, "Гонконг", 2600, 220, 1100, 3300, 8000, 9750, 11500, 1500, 1500),
         EnergyCard(28, "Энергия ветра"),
         CityCard(29, 6, "Иерусалим", 2800, 240, 1200, 3600, 8500, 10250, 12000, 1500, 1500),
         Card(30, "Тюрьма"),
         CityCard(31, 7, "Париж", 3000, 260, 1300, 3900, 9000, 11000, 12750, 2000, 2000),
         CityCard(32, 7, "Белград", 3000, 260, 1300, 3900, 9000, 11000, 12750, 2000, 2000),
         Card(33, "Шанс"),
         CityCard(34, 7, "Кейптаун", 3200, 280, 1500, 4500, 10000, 12000, 14000, 2000, 2000),
